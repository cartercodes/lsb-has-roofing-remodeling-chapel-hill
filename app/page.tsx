...
const services = [
  { title: 'Roof Replacement', desc: 'When Carolina storms take their toll, HAS Roofing & Remodeling delivers full roof replacements built to handle Chapel Hill\'s humid summers and unpredictable hurricane season. Premium materials, precise installation, lasting protection.', icon: serviceIcons[0] },
  { title: 'Storm Damage Repair', desc: 'Hail, wind, and fallen branches are part of life in the Triangle. Our crew responds fast to storm damage across Chapel Hill and surrounding areas, working directly with your insurance to get your roof restored right.', icon: serviceIcons[1] },
  { title: 'Roof Inspections', desc: 'Catch small problems before they become expensive ones. Our detailed inspections give Chapel Hill homeowners a clear picture of their roof\'s condition and an honest assessment of what it needs.', icon: serviceIcons[2] },
  { title: 'Gutter Installation', desc: 'Protect your home\'s foundation and landscaping from North Carolina\'s heavy rainfall. We install seamless gutters engineered to handle the downpours Chapel Hill sees every spring and summer.', icon: serviceIcons[3] },
  { title: 'Home Remodeling', desc: 'From kitchen upgrades to full exterior renovations, HAS Roofing & Remodeling brings the same craftsmanship indoors. We help Chapel Hill homeowners transform their spaces without the hassle of juggling multiple contractors.', icon: serviceIcons[4] },
  { title: 'Siding & Exteriors', desc: 'Give your home a fresh face that stands up to Carolina weather year after year. We install durable, beautiful siding that boosts curb appeal and protects against moisture damage.', icon: serviceIcons[5] },
];

const trustItems = [
  'Serving Chapel Hill & the Triangle for Over a Decade',
  'Licensed, Bonded & Fully Insured in North Carolina',
  'Hundreds of Five-Star Reviews from Orange County Homeowners',
  'Free Estimates with No-Pressure, Transparent Pricing',
];
    ...
    <>
      ...
      <nav className="nav" role="navigation" aria-label="Main navigation">
        <div className="nav-inner">
          <span className="nav-logo">{'HAS Roofing & Remodeling'}</span>
          <a
            href="tel:19199672072"
            className="nav-phone-btn"
            aria-label="Call HAS Roofing & Remodeling at +1 919-967-2072"
          >
            <span
            ...
            />
            <span className="nav-phone-text">{'+1 919-967-2072'}</span>
          </a>
        </div>
      </nav>
        ...
        <div className="hero-content">
          <div className="hero-glass-card">
            ...
            <h1 className="hero-title">
              Expert Roofing Contractor in {'Chapel Hill'}, {'NC'}
            </h1>
            <p className="hero-subtitle">
              From storm damage repairs to complete roof replacements,{' '}
              {'HAS Roofing & Remodeling'} delivers durable, code-compliant roofing
              solutions that protect your home and family across {'Chapel Hill'}.
            </p>
            <a
              href="tel:19199672072"
              className="hero-cta"
              aria-label="Call now at +1 919-967-2072"
            >
              <span
        ...
        <div className="about-inner">
          ...
          <div className="about-content">
            ...
            <h2 className="about-title" data-animate data-delay="1">
              Why {'Chapel Hill'} Trusts {'HAS Roofing & Remodeling'}
            </h2>
            <p className="about-text" data-animate data-delay="2">
              {'HAS Roofing & Remodeling has built its reputation one Chapel Hill rooftop at a time. From the tree-lined neighborhoods near Franklin Street to the growing communities of southern Orange County, we bring honest pricing, skilled craftsmanship, and a commitment to doing the job right the first time. When your home needs attention, we treat it like our own.'}
            </p>
        ...
        <div className="cta-section-inner" data-animate>
          <div className="cta-glass-card">
            <h2 className="cta-section-title">
              Contact {'HAS Roofing & Remodeling'}
            </h2>
      ...
      <footer className="footer" role="contentinfo">
        <div className="footer-inner">
          <span className="footer-brand">{'HAS Roofing & Remodeling'}</span>
          <div className="footer-info">
            <div className="footer-info-item">
              ...
              />
              <span>
                {'3322 Elva Ln, Chapel Hill, NC 27516, USA'}, {'Chapel Hill'}, {'NC'}
              </span>
            </div>
            <div className="footer-info-item">
              <span
          ...
          <div className="footer-copyright">
            &copy; {new Date().getFullYear()} {'HAS Roofing & Remodeling'}. All rights
